...
export const ui = {
  ...
  cards: {
    ...
    moonTraitNote: 'This moon-phase tendency is separate from your moon sign',
    moonSign: 'Moon Sign',
    moonSignLabel: 'Your inner emotional world',
    moonSignNote: 'Calculated at local noon since exact birth time is unknown. Cusp-day births may fall in the neighboring sign.',
  ...
  share: {
    panelTitle: 'STAR MAP',
    panelDesc: 'Star map and Tree of Life — share your life path, sun sign, and name on Instagram.',
    panelSteps: 'Tap Share to Instagram, or save the image and post it.',
    cardSectionTitle: 'STAR MAP card',
    previewHint: 'Tap to enlarge',
    previewAria: 'Enlarge STAR MAP card',
    previewAlt: (name) => `${name}'s STAR MAP card`,
    save: 'Save image',
    ...
    saved: 'Image saved',
    shareFail: 'Could not share',
    instagramUnsupported: 'Save the image, then open Instagram.',
    imageFail: 'Could not generate share image',
    modalAlt: 'STAR MAP card preview',
    birthDate: (y, m, d) => `${m}/${d}/${y}`,
    tweetHeader: '✦ COSMIC ID ✦',
    tweetLifePath: (lp, label) => `Life Path ${lp} · ${label}`,
    tweetTarot: (name) => `Tarot: ${name}`,
    tweetPersonalYear: (year, py) => `Personal Year ${py} in ${year}`,
    tweetSep: ' | '
  },
  love: {
