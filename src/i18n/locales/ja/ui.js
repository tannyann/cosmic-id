...
export const ui = {
  ...
  cards: {
    ...
    moonTraitNote: '月相からの傾向は月星座とは別の指標です',
    moonSign: '月星座',
    moonSignLabel: '感情・内面のあり方',
    moonSignNote: '出生時刻が不明なため正午基準で算出しています。境界日生まれは隣の星座の場合もあります。',
    zodiac: '十二支',
    sixty: '年柱(六十干支)',
    kyusei: '本命星(九星気学)',
  ...
  share: {
    panelTitle: 'STAR MAP',
    panelDesc: 'スター・マップと生命の樹。ライフパス・星座・名前入りカードを Instagram に投稿できます。',
    panelSteps: '「Instagram でシェア」または「画像を保存」→ Instagram に投稿',
    cardSectionTitle: 'STAR MAP カード',
    previewHint: 'タップで拡大',
    previewAria: 'STAR MAP カードを拡大表示',
    previewAlt: (name) => `${name}さんの STAR MAP カード`,
    save: '画像を保存',
    shareInstagram: 'Instagram でシェア',
    loading: '生成中…',
    loadFail: '生成に失敗',
    saved: '画像を保存しました',
    shareFail: '共有できませんでした',
    instagramUnsupported: '保存してから Instagram を開いてください',
    imageFail: 'シェア画像の生成に失敗しました',
    modalAlt: 'STAR MAP カードのプレビュー',
