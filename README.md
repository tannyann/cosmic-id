...
> **正式ロードマップ（未実装）**: 回答式のDAY SIGNAL 8タイプ × NIGHT GRAVITY 8タイプを
> 中核IDとし、生年月日由来の12 Cosmic Coordinatesを人格分類とは分離して添える。
> 既存19体系はCOSMIC ATLASとして維持する。詳細は
> [`docs/plan/persona-architecture.md`](docs/plan/persona-architecture.md)。
